...
You can now visit the presentation console and projector viewport at the following URLs:
 ...
 Projector viewport::
 \http://localhost:4242/pages/slide-deck-viewer/slide-deck-viewer-page.html

 Presentation console::
 \http://localhost:4242/pages/teleprompter-console/teleprompter-console-page.html?slide-deck-url=http://localhost:4321/my-awesome-slide-deck.html
